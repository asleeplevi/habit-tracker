    ...
    <div className="mt-6 flex flex-col gap-3">
      {day?.possibleHabits.map((habit) => {
        ...
        return (
          ...
          >
            <div className="transition-colors h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-green-500 group-data-[state=checked]:border-green-500  focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background">
              <Checkbox.Indicator>
